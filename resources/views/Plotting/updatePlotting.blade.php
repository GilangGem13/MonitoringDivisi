...
<div class="card-body">
    ...
    <form method="post" action="{{ route('PlottingBRI.ubah.post',$data->id) }}"  enctype="multipart/form-data">
    @csrf   
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
                <label class="col-sm-2 col-form-label">Divisi</label>
                <div class="col-sm">
                    <input class="form-control" name="divisi" value="{{ old('divisi', $data->divisi) }}"  rows="1" placeholder="Masukkan divisi"></input>
                </div>                                                
            </div>
            @php
            ...
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
                ...
                <div class="col-sm">
                    <textarea rows="4" cols="130" name="rencana_divisi" value="{{ old('rencana_divisi', $data->rencana_divisi) }}" placeholder="Detail">{{ $data->rencana_divisi }}</textarea>
                </div>                                                
            </div>
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
