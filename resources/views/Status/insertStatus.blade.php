...
@section ('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('Status.tambah.post') }}" class="form-horizontal" enctype="multipart/form-data" >
            @csrf   
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
                <label class="col-sm-2 col-form-label">Status</label>
                <div class="col-sm">
                    <input class="form-control" name="status" rows="1" placeholder="Masukkan Status"></input>
                </div>                                                
            </div>
