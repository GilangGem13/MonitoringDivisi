...
<div class="card-body">
    ...
    <form method="post" action="{{ route('Lantai.ubah.post',$data->id) }}"  enctype="multipart/form-data">
    @csrf   
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
                <label class="col-sm-2 col-form-label">Lantai</label>
                <div class="col-sm">
                    <input class="form-control" name="lantai" value="{{ old('lantai', $data->lantai) }}" rows="1" placeholder="Masukkan Lantai"></input>
                </div>                                                
            </div>
