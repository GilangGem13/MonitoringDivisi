...
<div class="card-body">
    ...
    <form method="post" action="{{ route('DataDivisi.ubah.post',$data->id) }}"  enctype="multipart/form-data">
    @csrf   
            <div class="input-group col-sm offset-md-auto mb-4 mt-4">
                <label class="col-sm-2 col-form-label">Data Divisi</label>
                <div class="col-sm">
                    <input class="form-control" name="datadivisi" value="{{ old('datadivisi', $data->datadivisi) }}" rows="1" placeholder="Masukkan Data Divisi"></input>
                </div>                                                
            </div>
